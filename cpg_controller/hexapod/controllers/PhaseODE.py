...
class PhaseODE():
    def __init__(self,amplitudes, phase_bias, weights=20.0, seconds=5, refresh_rate=240) -> None:
        """
        ...
        self.num_oscillators = 12 #TODO: make dynamic
    ...
    def __calculate_phases(self):
        ...
        for t in range(1,(self.num_steps)): #TODO: check this self.num_steps-1
            # print(t)
            for leg in range(6):
