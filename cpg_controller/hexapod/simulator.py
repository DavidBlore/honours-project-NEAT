...
if __name__ == "__main__":
	...
	from controllers.cpg_controller_mouret import CPGControllerMouret
	...
	# cpg_controller = CPGControllerMouret(np.random(342))
	simulator = Simulator(controller=controller, follow=False, visualiser=True, collision_fatal=False,failed_legs=[1,2,3,4,5,6], camera_distance=1.0, camera_yaw=90, camera_pitch=-55)
	print(controller.joint_angles(t=0))
	while True:
		simulator.step()
